...
if (dataset=='apv'):
    ...
    srocc_list = Parallel(n_jobs=-1,verbose=0)(delayed(apv_train)(i,live_feats,live_scores) for i in range(1000))
    ##srocc_list = np.nan_to_num(srocc_list)
    with open('overall_result.txt', 'a') as f:
